...
`java_redis_sha256sum`). E.g. to perform an offline install of `11.0.6+10.1`:
...
- hosts: servers
  roles:
    - role: gantsign.java
      ...
      java_version: '11.0.6+10.1'
      java_release_name: 'jdk-11.0.6+10'
